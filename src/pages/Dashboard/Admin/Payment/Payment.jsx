                        ...
                        <tbody>
                            {
                                payments.map((item, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <button disabled={item?.status === 'paid'} className={` text-center rounded-full py-1 cursor-pointer  w-32 m-auto ${item?.status == 'paid' ? 'bg-gray-400 text-gray-500 cursor-not-allowed': 'bg-green-300  text-green-800'}`} onClick={() => handleAcceptPayment(item?._id)}  >accept payment</button>
                                        </td>
                                    </tr>
                                ))
                            }
